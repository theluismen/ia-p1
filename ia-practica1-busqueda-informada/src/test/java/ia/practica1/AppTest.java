...
import ia.practica1.heuristicas.Euclidea;
...
public class AppTest 
{
    ...
    public void test01 () {
        ...
        try {
            ...
            System.out.println("L'heuristica a l'estat inicial es:"+mapa.getHeuristica().evaluar(mapa.getInicial()));
    ...
    // A* amb heuristica constante para prueba
    @Test
    public void test02 () {
        Mapa mapa;
        Solucion solucion;
